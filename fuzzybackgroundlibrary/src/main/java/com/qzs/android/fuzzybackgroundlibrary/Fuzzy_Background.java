package com.qzs.android.fuzzybackgroundlibrary;
...
public class Fuzzy_Background {
     ...
     * @return
     */
    public static Fuzzy_Background with(Context context){
        if (singleton == null) {
            synchronized (Fuzzy_Background.class) {
                if (singleton == null) {
                    singleton = new Fuzzy_Background(context);
                }
            }
        }
        return singleton;
    ...
    private Fuzzy_Background(Context context){
     ...
     * @return
     */
    public Fuzzy_Background policy(BlurPolicy policy){
        this.mPolicy = policy;
        return this;
    }
     ...
     * @return
     */
    public Fuzzy_Background bitmap(Bitmap bitmap){
        this.mBitmap = bitmap;
        return this;
    }
     ...
     * @return
     */
    public Fuzzy_Background scale(int scale){
     ...
     * @return
     */
    public Fuzzy_Background radius(int radius){
        this.mRadius = radius;
        return this;
    }
